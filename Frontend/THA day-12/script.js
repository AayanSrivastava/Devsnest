...
function addTodo(){
    ...
    newTodo.className = 'card-col';
    newTodo.innerHTML += '<div class="card" style="width: 18rem;"><div class="card-top">' + day + ' Day' +
    '<div><p class="card-main">'+ todoName.value +'</p><input type="button"  class="btn" value="Delete"></div></div>';
...
todoList.addEventListener("click", function(event){
    ...
    if(event.target.className != 'card-main'){
...
function getTodos() {
    ...
    if(todos != null){
        for (let i = 0; i < todos.length;i++){
            ...
            newTodo.className = 'card-col';
            newTodo.innerHTML += '<div class="card" style="width: 18rem;"><div class="card-top">' + day + ' Day' +
            '<div><p class="card-main">'+ todos[i].todo_name +'</p><input type="button" class="btn" value="Delete"></div></div>';
            newTodo.id = "todo" + todoList.childElementCount;
            todoList.appendChild(newTodo);
        }
    }
